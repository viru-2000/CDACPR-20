  ...
  return (
    <>
      ...
      <section class="bg-light py-4 text-center">
        <p class="mb-0">
          Partnered with <strong>IKEA</strong>
        </p>
        <p>Get started faster. Download our app.</p>
        <div class="d-flex justify-content-center gap-2">
          <button
            class="btn btn-outline-dark"
            onClick={() => openAppStore("https://www.apple.com/in/app-store/")}
          >
            App Store
          </button>
          <button
            class="btn btn-outline-dark"
            onClick={() =>
              openAppStore("https://play.google.com/store/apps?hl=en")
            }
          >
            Google Play
          </button>
